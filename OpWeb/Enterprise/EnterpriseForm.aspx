                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="3" style="text-align: center;">
                    <tbody>
                        <tr>
                            ...
                            <td width="200">
                                <input name="E_creditCode" type="text" class="form-control" id="E_creditCode" value="" runat="server" /></td>
							<td width="100"><label class="control-label">类　　型：</label>
                                </td>
                            <td width="337"><input name="E_enterpriseType" type="text" class="form-control" id="E_enterpriseType" value="" runat="server" />
                                </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
