...
{
    public partial class EnterpriseAccount : System.Web.UI.Page
    {
        private string _key;
        bool IsEdit = false;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            IsEdit = DataFactory.SqlDataBase().IsExist("EnterpriseAccount", "E_enterpriseID", this._key) > 0 ? true : false;
            if (!base.IsPostBack)
            {
        ...
        {
            Hashtable ht = DataFactory.SqlDataBase().GetHashtableById("EnterpriseAccount", "E_enterpriseID", this._key);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            bool IsOk = DataFactory.SqlDataBase().Submit_AddOrEdit("EnterpriseAccount", "E_enterpriseID", id, ht);
            if (IsOk)
            {
