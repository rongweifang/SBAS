...
{
    public partial class Approve_Center : System.Web.UI.Page
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.peridal.GetApproveListPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
