...
{
    public partial class Contract_OneCard : System.Web.UI.Page
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.peridal.GetOneCardListPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
