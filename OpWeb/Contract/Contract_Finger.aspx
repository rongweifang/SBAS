...
not supported by any browser */
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ChangeSelect(fid, fname) {
            ...
            $("#Page1").attr("src", "/Contract/HtmlToImage.aspx?FID=" + fid + "&documentType=<%=ContractType%>");
            $('#LB_Sign').empty();
...
<body onload="loads()" onunload="unloads()">
    ...
    <div class="col-sm-12" style="height: 100%; overflow-x: hidden; overflow-y: auto; width: 150px; float: left; z-index: 99">
    ...
    <div style="height: 100%; width: 820px; float: left; display: block; position: absolute; z-index: 1">
        <div id="CanvasPannl" style="height: 550px; width: 700px; padding-top: 20%; margin-left: 25%; display: <% =_Vis%>;background-repeat:no-repeat;background-position:center;z-index:10">
           <div style="z-index:-1;position:absolute;height: 550px; width: 700px; top:0;" class="noselect">
             <iframe class="noselect" name="Page1" id="Page1" width="100%" height="100%" src="/Contract/HtmlToImage.aspx?FID=<%=FID.Value%>&documentType=<%=ContractType%>"  style="zoom:100%" frameborder="0" scrolling="no"></iframe>
           </div>
             <div class="col-sm-4" style="width: 180px; float: left; height: 360px; margin: 0; padding: 0; overflow: hidden;">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-info-circle"></i><span id="LB_Finger"><%=FistFingerName %></span>
                    </div>
                    <div class="panel-body">
                        <div style="text-align: center; height: 195px; vertical-align: middle;">
            ...
            <div class="col-sm-4" style="width: 510px; height: 360px; float: right; overflow: hidden; margin: 0; padding: 0;">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-info-circle"></i>签名区域-<span id="LB_Sign"><%=FistFingerName %></span>
                    </div>
                    <div class="panel-body">
                        <div style="width: 100%; height: 195px; text-align: center;">
                            <object id="HWPenSign" name="HWPenSign" classid="clsid:E8F5278C-0C72-4561-8F7E-CCBC3E48C2E3" width="420" height="180" style="margin: 0; padding: 0;"></object>
                        </div>
                        <div style="width: 100%; text-align: center; margin-top: 15px;">
        ...
        <div style="width: 100%; text-align: center; position: fixed; bottom: 0px; padding-bottom: 20px;">
