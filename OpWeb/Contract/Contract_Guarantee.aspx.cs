...
{
    public partial class Contract_Guarantee : System.Web.UI.Page
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.peridal.GetGuaranteeListPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
