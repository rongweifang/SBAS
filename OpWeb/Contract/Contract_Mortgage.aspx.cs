...
{
    public partial class Contract_Mortgage : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.peridal.GetMortgageListPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
