...
{
    public partial class Contract_PrintList : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.peridal.GetHistoryListPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
