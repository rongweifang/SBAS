<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomTypeManage.aspx.cs" Inherits="OpWeb.RMBase.SysBase.CustomTypeManage" %>
                    ...
                    <tbody style="line-height: 35px;">
                        ...
                        <asp:Repeater ID="rp_Item" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td style="width: 20px; text-align: left;">
                                        <input id="CID" type="checkbox" value="<%#Eval("Id") %>" name="checkbox" />
                                    </td>
                                    <td style="width: 80px; text-align: center;"><%#Eval("TypeNo") %></td>
                                    <td style="width: 140px; text-align: center;"><%#Eval("Name") %></td>
                                    <td style="width: 70px; text-align: center;"><%#Eval("CreateTime") %></td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                                <% if (rp_Item != null)
