    ...
    public partial class User_Photo : System.Web.UI.Page
    {
        ...
        private void InitData()
        {
            ...
            if (ht.Count > 0 && ht != null)
            {
                ...
                if (ht.Contains("ID01"))
                {
                    string _ID01 = ht["ID01"].ToString().Trim();
                    this.ViewState["ID01"] = _ID01;
                    ID01Data = string.Format("data:image/jpg;base64,{0}", string.IsNullOrEmpty(_ID01) ? _d1 : _ID01);
                }
                if (ht.Contains("ID02"))
                {
                    string _ID02 = ht["ID02"].ToString().Trim();
                    this.ViewState["ID02"] = _ID02;
                    ID02Data = string.Format("data:image/jpg;base64,{0}", string.IsNullOrEmpty(_ID02) ? _d1 : _ID02);
                }
