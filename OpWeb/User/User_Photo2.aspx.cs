...
{
    public partial class User_Photo2 : System.Web.UI.Page
    {
        private string Card_ID;
        private string _key;
        public string SceneHeadData = string.Empty;
        public string SceneWorkerData = string.Empty;
        public string SceneGroupData = string.Empty;
