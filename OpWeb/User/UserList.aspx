    ...
    <script type="text/javascript">
        ...
        function EditSymbiosis(Card_ID) {
            if (IsEditdata(Card_ID)) {
                ...
                top.openDialog(url, 'User_Symbiosis', '共同居住人信息 - 编辑', 700, 630, 50, 50);
            }
        }
        //保证人
        function EditWarrantor(Card_ID) {
            if (IsEditdata(Card_ID)) {
                ...
                top.openDialog(url, 'User_Warrantor', '保证人信息 - 编辑', 700, 630, 50, 50);
            }
        }
        //申请人信息
                ...
                <table id="table1" class="grid" singleselect="false">
                    <thead>
                        <tr>
                            ...
                            <td style="width: 70px; text-align: center;">申请人信息</td>
                        ...
                        <asp:Repeater ID="rp_Item" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="width: 70px; text-align: center;"><a onclick="EditExtra('<%#Eval("Card_ID")%>')">
                                        <img src="../img/Browser_pen.png" width="35" height="35" alt="" /></a>
                                    </td>
                                    ...
                                    <td style="width: 70px; text-align: center;">
                                        <a onclick="EditSymbiosis('<%#Eval("Card_ID")%>')"><img src="../img/family.png" width="35" height="35" alt="" /> </a>
                                    </td>
                                    <td style="width: 50px; text-align: center;">
                                        
                                        <a onclick="EditWarrantor('<%#Eval("Card_ID")%>')"><img src="../img/matte_white.png" width="35" height="35" alt="" /> </a>
                                    </td>
                                    <td style="width: 70px; text-align: center;">
                                        
                                        <a onclick="EditContract('<%#Eval("Card_ID")%>')"><img src="../img/contract_740.png" width="35" height="35" alt="" /> </a>
                                    </td>
