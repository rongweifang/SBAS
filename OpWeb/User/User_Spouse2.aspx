<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Spouse2.aspx.cs" Inherits="OpWeb.User.User_Spouse2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function Base64_Front() {
            ...
            $("#SID01").val(show.GetBase64(name));
            $("#SID01_IMG").attr('src', 'data:image/jpg;base64,' + show.GetBase64(name));
            show.DeleteFile(name);
        }
        function Base64_Reverse() {
            var name = show.GetTempFileName(".jpg");
            show.Capture(name);
            $("#SID02").val(show.GetBase64(name));
            $("#SID02_IMG").attr('src', 'data:image/jpg;base64,' + show.GetBase64(name));
            show.DeleteFile(name);
        }
        //reverse
    </script>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="160" style="background: #F5F5F5">
                                    <img id="SID01_IMG" src="<%=SID01Data %>" width="160" height="120" /></td>
                                <td width="20" style="text-align: center">身份证背面</td>
                                <td width="160" style="background: #F5F5F5">
                                    <img id="SID02_IMG" src="<%=SID02Data %>" width="160" height="120" /></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                    ...
                    <form id="form1" runat="server">
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" id="SID01" runat="server" />
                                <input type="hidden" id="SID02" runat="server" />
