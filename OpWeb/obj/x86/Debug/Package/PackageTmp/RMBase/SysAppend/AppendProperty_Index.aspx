<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppendProperty_Index.aspx.cs"
    Inherits="Manage.RMBase.SysAppend.AppendProperty_Index" %>
...
<body>
    ...
    <div id="iframeMainContent">
        <div class="iframeleft">
            <iframe id="target_left" name="target_left" scrolling="auto" frameborder="0" width="100%" height="100%"></iframe>
        </div>
        <div class="iframeContent">
            <iframe id="target_right" name="target_right" scrolling="auto" frameborder="0" width="100%" height="100%"></iframe>
        </div>
    </div>
    </form>
</body>
