...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            top.openDialog(url, 'Company_form', '公司信息 - 添加', 700, 630, 50, 50);
        }
        //修改
        function edit() {
            ...
            if (IsEditdata(key)) {
                ...
                top.openDialog(url, 'Company_form', '公司信息 - 编辑', 700, 630, 50, 50);
            }
        }
        //删除
        function Delete() {
        ...
        <div class="btnbarcontetn">
            <div style="float: left;">
                ...
                <select id="specName" class="Searchwhere" runat="server">
                    <option value="companyName">专业名称</option>
                </select>
                    ...
                    <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_Item_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 150px; text-align: left;">
                                    <%#RM.Common.DotNetCode.CommonHelper.GetFormatDateTime(Eval("beginDate"),"MM月dd")%> 至 <%#RM.Common.DotNetCode.CommonHelper.GetFormatDateTime(Eval("endDate"),"MM月dd")%>
                                </td>
