<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainDefault.aspx.cs" Inherits="Manage.Frame.MainDefault" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>内蒙古电力（集团）有限责任公司-招聘平台后台管理</title>
...
<body>
    ...
    <div id="Container">
        <div id="Header">
            <div id="HeaderLogo">内蒙古电力（集团）有限责任公司-招聘平台后台管理
        ...
        <div id="MainContent">
            ...
            <div id="Content">
                <iframe id="main" name="main" scrolling="auto" frameborder="0" width="100%"
