            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="client-status">
                       <asp:Button ID="Btn_Jie" class="btn btn-warning btn-xs" runat="server" Text="创　建" OnClick="Btn_Jie_Click" />
                    </td>
                </tr>
                <tr>
                    <td class="client-avatar">
                    ...
                    <td class="client-status">
                        <asp:Button ID="Btn_Bao" class="btn btn-warning btn-xs" runat="server" Text="创　建" OnClick="Btn_Bao_Click" />
                    </td>
                </tr>
                <tr>
                    <td class="client-avatar">
                    ...
                    <td class="client-status">&nbsp;</td>
                    <td class="client-status">
                        <asp:Button ID="Btn_Ya" class="btn btn-warning btn-xs" runat="server" Text="创　建" OnClick="Btn_Ya_Click" /></td>
                </tr>
                <tr>
                    <td class="client-avatar">
                    ...
                    <td class="client-status">&nbsp;</td>
                    <td class="client-status"><asp:Label ID="LB_Ka2" runat="server" Text=""></asp:Label></td>
                    <td class="client-status">
                ...
                <tr>
                    ...
                    <td class="client-status">&nbsp;</td>
                    <td class="client-status">
                       <asp:Button ID="Btn_Xin" class="btn btn-warning btn-xs" runat="server" Text="创　建" OnClick="Btn_Xin_Click" /></td>
                </tr>
            </tbody>
        </table>
