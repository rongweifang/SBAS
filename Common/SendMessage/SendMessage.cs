   ...
   public class SendMessage
    {
        ...
        private static readonly string ACCOUNT = "1001@500776600001";
        ...
        /* 内容, 500字以内, 多个用{|}分隔
        /************************************************************************/
        public static int sendBatch(string mobile, string content, uint uCgid = 0, uint uCsid = 0)
        {
            StringBuilder sb = new StringBuilder();
        ...
        /************************************************************************/
        public static int sendParam(string mobile, string content, string[] param, uint uCgid = 0, uint uCsid = 0)
        {
            StringBuilder sb = new StringBuilder();
