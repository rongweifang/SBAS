<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Zhaopin.company.Default" %>
...
<head runat="server">
    ...
    <title>企业简介-招聘平台-内蒙古电力（集团）有限责任公司</title>
...
<body>
    ...
    <uc1:head runat="server" ID="head" />
        <div id="wrap">
            ...
            <div id="location">
                <div class="left"> <a href="/company/">企业简介</a></div>
            </div>
            <div id="main_content">
                ...
                <div class="list">
                    <ul>
                        <asp:Repeater ID="rp_Item" runat="server">
                            <ItemTemplate>
                                <li><span class="l">• <a href="/company/CompanyNewsView.aspx?id=<%#Eval("companyID")%>" target="_blank"><%#Eval("companyName")%></a></span><span class="r">[  <%#Convert.ToDateTime(Eval("BeginDate")).ToString("yyyy-MM-dd")%>]</span></li>
                            </ItemTemplate>
                            <FooterTemplate>
                                <% if (rp_Item != null)
                                   {
