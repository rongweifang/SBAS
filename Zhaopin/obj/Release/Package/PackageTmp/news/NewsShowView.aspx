<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsShowView.aspx.cs" Inherits="Zhaopin.news.NewsShowView" %>
...
<head runat="server">
    ...
    <title><%=title %>-招聘动态-招聘平台-内蒙古电力（集团）有限责任公司</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="wrap">
            ...
            <div id="location">
                <div class="left"> <a href="/news/">招聘动态</a>&gt;<%=title %></div>
            </div>
            <div id="main_content">
