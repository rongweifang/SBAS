<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Zhaopin.CompanNews.Default" %>
...
<head runat="server">
    ...
    <title>公司新闻-招聘平台-内蒙古电力（集团）有限责任公司</title>
...
<body>
    ...
    <uc1:head runat="server" ID="head" />
        <div id="wrap">
            ...
            <div id="location">
                <div class="left"> <a href="/CompanNews/">公司新闻</a></div>
            </div>
            <div id="main_content">
                ...
                <div class="list">
                    <ul>
                        <asp:Repeater ID="rp_Item" runat="server">
                            <ItemTemplate>
                                <li><span class="l">• <a href="/CompanNews/NewsShowView.aspx?id=<%#Eval("newsID")%>" target="_blank"><%#Eval("title")%></a></span><span class="r">[ <%#Convert.ToDateTime(Eval("pubdate")).ToString("yyyy-MM-dd")%>]</span></li>
                            </ItemTemplate>
                            <FooterTemplate>
                                <% if (rp_Item != null)
                                   {
