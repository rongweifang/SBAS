    ...
    public partial class ComputerForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                {
                    Hashtable ht = DataFactory.SqlDataBase().GetHashtableById("ComputerLevel", "ID", this.CpmpID);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterStartupScript(Page.GetType(), "", "<script language=javascript>layer.msg('请选择证书名称！');</script>");
                return;
            }
            ...
            if (string.IsNullOrEmpty(this.CpmpID))
            {
                DataTable dt = peridal.GetComputerLevel();
            ...
            bool IsOk = DataFactory.SqlDataBase().Submit_AddOrEdit("ComputerLevel", "ID", this.CpmpID, ht);
            if (IsOk)
            {
