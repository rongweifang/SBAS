<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComputerForm.aspx.cs" Inherits="Zhaopin.UserCenter.ComputerForm" %>
                    ...
                    <ul class="gray30">
                        ...
                        <li>
                            <div class="form06">
                                ...
                                <div class="form13" style="overflow: hidden;">
                                    <div>
                        ...
                        <li>
                            <div class="form06">
                                ...
                                <div class="form03">
                                    <div>
                                        <input id="Grade" name="Grade" type="text" class="validate-specialchar input" value="" maxlength="20" runat="server" />
                                    </div>
                                </div>
                                <div style="color: red; width: 20px; float: left;"></div>
                            </div>
                        ...
                        <li>
                            <div class="form06">
                                ...
                                <div class="form03">
                                    <div>
                                        <input id="CertLevel" name="CertLevel" type="text" class="float-range-0-1000 input" value="" maxlength="5" runat="server" />
                                    </div>
                                    <div class="gray02"></div>
                                </div>
                            </div>
                                ...
                                <div class="form05">
                                    <div style="width: 320px; overflow: hidden;">
                                        <div style="width: 269px; float: left;">
                                            <asp:FileUpload ID="FileUpload1" runat="server" class="validate-file-pdf-jpg-jpeg input2" />
                                        </div>
                        ...
                        <li>
                            <div class="form07">
                                ...
                                <div class="form05">
                                    <asp:Button ID="Button1" runat="server" Text="保存" CssClass="btnsubmit" OnClientClick="chkAwardSubmit();" OnClick="Button1_Click" />
